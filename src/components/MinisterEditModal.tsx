...
import { X, Save, User, Mail, Calendar, Plus, CheckCircle2 } from 'lucide-react';
import { Registration, MinisterialTitle, MinisterialPosition, RegistrationStatus, Programme } from '../types';
...
export const MinisterEditModal: React.FC<MinisterEditModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/75 flex items-center justify-center p-3 sm:p-6 overflow-y-auto" onClick={onClose}>
      <div className="bg-white w-full max-w-3xl rounded-2xl shadow-2xl overflow-hidden border border-slate-200 max-h-[92vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
        {/* Header */}
        <div className="bg-slate-900 text-white p-5 sm:p-6 flex items-center justify-between shrink-0">
          <div>
            ...
            <h2 className="text-xl font-bold font-serif mt-1">Edit Minister Registration Details</h2>
          </div>
          <button
            type="button"
            onClick={onClose}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 rounded-xl bg-slate-50 border border-slate-200">
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 rounded-lg border border-slate-300 bg-white font-semibold text-slate-900 focus:ring-2 focus:ring-amber-500"
              >
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 rounded-lg border border-slate-300 bg-white font-medium text-slate-900 focus:ring-2 focus:ring-amber-500"
              >
                {programmes.map((p) => (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 rounded-lg border border-slate-300 bg-white text-slate-900 focus:ring-2 focus:ring-amber-500"
                >
              ...
              <div className="sm:col-span-2">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-lg border border-slate-300 bg-white text-slate-900 focus:ring-2 focus:ring-amber-500 font-semibold"
                />
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-lg border border-slate-300 bg-white text-slate-900 focus:ring-2 focus:ring-amber-500 font-bold"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-2 mb-2">
                <input
                  ...
                  className="flex-1 px-3 py-1.5 rounded-lg border border-slate-300 bg-white text-xs text-slate-900 focus:ring-2 focus:ring-amber-500"
                />
                <button
                  type="button"
            ...
            <div>
              <label className="block text-xs font-medium text-slate-700 mb-1">
                Internal Secretariat Notes / Special Requests
              </label>
              <textarea
                rows={2}
                ...
                className="w-full px-3 py-2 rounded-lg border border-slate-300 bg-white text-xs text-slate-900 focus:ring-2 focus:ring-amber-500"
              />
            </div>
          </div>
