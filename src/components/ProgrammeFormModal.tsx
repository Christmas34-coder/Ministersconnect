...
export const ProgrammeFormModal: React.FC<ProgrammeFormModalProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSave({
      ...
      description:
        description.trim() ||
        `${title} - Programme for equipping, apostolic alignment, and spiritual refreshment.`,
      ...
      materialsIncluded: [
        'Ministerial Conference Manual',
        'Executive Accreditation Badge',
        'Lunch Refreshments',
  ...
  return (
    ...
    >
      <div
        className="bg-white w-full max-w-4xl rounded-2xl shadow-2xl overflow-hidden border border-slate-200 max-h-[92vh] flex flex-col"
        ...
        <form onSubmit={handleSubmit} className="overflow-y-auto p-6 space-y-6 flex-1 text-sm">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block font-semibold text-slate-700 mb-1">
                  Programme Theme <span className="text-red-500">*</span>
                </label>
                <input
                  type="text"
                  value={theme}
          ...
          <div className="pt-4 border-t border-slate-200 flex flex-wrap items-center gap-6">
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              <span className="text-xs font-semibold text-slate-800">
                Highlight as Featured Programme on Home
              </span>
            </label>
